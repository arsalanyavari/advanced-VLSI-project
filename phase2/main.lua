...
-- Switch between file tree and code window Ctrl + Shift + E
vim.api.nvim_set_keymap('n', '<C-S-E>', ':lua ToggleNvimTree()<CR>', { noremap = true, silent = true })

-- Save file with Ctrl+S and open save dialog with Ctrl+Shift+S
vim.api.nvim_set_keymap('n', '<C-s>', ':w<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-S-s>', ':lua SaveAsDialog()<CR>', { noremap = true, silent = true })

-- Lua function to open save dialog
...
require'lualine'.setup {
  ...
  sections = {
    ...
    lualine_z = {
      ...
      {
        function()
          local total, errors = vim.fn.spellbadword()
          return string.format('Spell: %d', errors)
        end,
        color = { fg = 'red' }
      }
    }
